...
macro( TargetBuildAndAddProto TARGET_NAME PROTO_FILE PROTO_OUTPUT_FOLDER )
    ...
    add_custom_command(
            ...
            ARGS --cpp_out=. --proto_path=${SRCDIR}/game/shared/tf --proto_path=${SRCDIR}/thirdparty/protobuf-2.5.0/src --proto_path=${SRCDIR}/gcsdk --proto_path=${SRCDIR}/game/shared --proto_path=${SRCDIR}/game/shared/econ --proto_path=${SRCDIR}/common ${PROTO_FILE}
